class ProductsController < ApplicationController
  ...
  # GET /products.json
  def index
    @products = Product.order(:name).includes(:category).order("categories.name asc")
  end
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:category_id, :name, :quantity, :minimum_quantity, :measure_unit)
    end
end